...
#include "../../drivers/net/n3k/mgmt/regs/n3k_mgmt_flow_tbl_regs_api.h"
#include "../../drivers/net/n3k/mgmt/regs/n3k_mgmt_tunnel_tbl_regs_api.h"
#include "../../drivers/net/n3k/mgmt/regs/n3k_mgmt_flow_tracker_regs_api.h"

#include <rte_common.h>

#include "n3k_dump_debug_regs.h"

static const struct regs_array_description debug_regs_array[] = {
	{
...
static const struct regs_description debug_regs[] = {
	{
...
void
get_debug_regs_desc(const struct regs_description **regs, size_t *size)
{
	*size = RTE_DIM(debug_regs);
	*regs = debug_regs;
}

void
get_debug_regs_array_desc(const struct regs_array_description **regs_arr,
	size_t *size)
{
	*size = RTE_DIM(debug_regs_array);
	*regs_arr = debug_regs_array;
}
