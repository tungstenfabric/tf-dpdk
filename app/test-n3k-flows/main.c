...
static void prepare_l3_key(struct n3k_mgmt_flow_tbl_l3 *l3_key,
		enum key_address_type kat, uint8_t addr_fill) {

	switch (kat) {
		case IPv4:
			l3_key->type = N3K_MGMT_FLOW_TBL_L3_TYPE_IPV4;
			l3_key->ipv4.src_ip = RTE_IPV4(addr_fill, addr_fill, addr_fill, 6);
			l3_key->ipv4.dst_ip = RTE_IPV4(addr_fill, addr_fill, addr_fill, 7);
			break;

		case IPv6:
			l3_key->type = N3K_MGMT_FLOW_TBL_L3_TYPE_IPV6;
			memset(l3_key->ipv6.src_ip, addr_fill, IPv6_ADDR_LEN - 1);
			memset(l3_key->ipv6.dst_ip, addr_fill, IPv6_ADDR_LEN - 1);
			l3_key->ipv6.src_ip[IPv6_ADDR_LEN - 1] = 6;
			l3_key->ipv6.dst_ip[IPv6_ADDR_LEN - 1] = 7;
			break;
	}
}

__rte_unused static struct n3k_mgmt_flow_entry
create_local_flow_entry(int id, enum key_address_type kat)
{
...
__rte_unused static struct n3k_mgmt_flow_entry
create_vxlan_encap_flow_entry(int id, enum key_address_type kat)
{
	struct n3k_mgmt_flow_entry flow;
	memset(&flow, 0, sizeof(flow));
	struct rte_ether_addr *smac = &flow.action.tunnel.smac_raw;
...
__rte_unused static struct n3k_mgmt_flow_entry
create_vxlan_decap_flow_entry(int id, enum key_address_type kat)
{
	struct n3k_mgmt_flow_entry flow;
	memset(&flow, 0, sizeof(flow));
...
__rte_unused static struct n3k_mgmt_flow_entry
create_drop_flow_entry(int id, enum key_address_type kat)
{
	struct n3k_mgmt_flow_entry flow;
	memset(&flow, 0, sizeof(flow));
	struct n3k_mgmt_flow_tbl_key *key = &flow.key.key_raw;
...
__rte_unused static struct n3k_mgmt_flow_entry
create_decap_flow_entry(int id, enum key_address_type kat)
{
	struct n3k_mgmt_flow_entry flow;
	memset(&flow, 0, sizeof(flow));
	struct n3k_mgmt_vplkp_tbl_res *vplkp = &flow.key.vplkp_raw;
...
__rte_unused static struct n3k_mgmt_flow_entry
create_decap_l3_flow_entry(int id, enum key_address_type kat)
{
	struct n3k_mgmt_flow_entry flow;
	memset(&flow, 0, sizeof(flow));
	struct n3k_mgmt_vplkp_tbl_res *vplkp = &flow.key.vplkp_raw;
...
// local_IPv6 = Ether(src="10:11:12:13:14:15", dst="16:17:18:19:1a:1b")/IP(src="101:0101:0101:0101:0101:0101:0101:0106", dst="101:0101:0101:0101:0101:0101:0101:0107")/UDP(sport=1116, dport=1117)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_local_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_local_flow_entry(id, kat);
...
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_local_nat_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;
...
// encap_nat_IPv6 = Ether(src="20:21:22:23:24:25", dst="26:27:28:29:2a:2b")/IPv6(src="202:0202:0202:0202:0202:0202:0202:0206", dst="202:0202:0202:0202:0202:0202:0202:0207")/UDP(sport=2227, dport=2227)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_encap_nat_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_encap_flow_entry(id, kat);
...
// decap_nat_IPv6 = Ether()/IP(src="4.4.4.8", dst="4.4.4.9")/UDP(dport=6635)/MPLS(label=54321, cos=3)/Ether(src="40:41:42:43:44:45", dst="46:47:48:49:4a:4b")/IP(src="404:0404:0404:0404:0404:0404:0404:0406", dst="404:0404:0404:0404:0404:0404:0404:0407")/UDP(sport=4447, dport=4447)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_decap_nat_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_decap_flow_entry(id, kat);
...
//local_IPv6 = Ether(src="10:11:12:13:14:15", dst="16:17:18:19:1a:1b")/IP(src="101:0101:0101:0101:0101:0101:0101:0106", dst="101:0101:0101:0101:0101:0101:0101:0107")/UDP(sport=1117, dport=1117)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *add_local_mirror_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;
...
// encap_IPv6 = Ether(src="20:21:22:23:24:25", dst="26:27:28:29:2a:2b")/IP(src="202:0202:0202:0202:0202:0202:0202:0206", dst="202:0202:0202:0202:0202:0202:0202:0207")/UDP(sport=2226, dport=2227)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_encap_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;
...
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_drop_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_drop_flow_entry(id, kat);
...
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_decap_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;
...
// decap_IPv6 = Ether()/IP(src="4.4.4.8", dst="4.4.4.9")/UDP(dport=6635)/MPLS(label=54321, cos=3)/Ether(src="40:41:42:43:44:45", dst="46:47:48:49:4a:4b")/IP(src="404:0404:0404:0404:0404:0404:0404:0406", dst="404:0404:0404:0404:0404:0404:0404:0407")/UDP(sport=4447, dport=4447)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *add_decap_mirror_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;
...
// encap_l3_IPv6 = Ether(src="50:51:52:53:54:55", dst="56:57:58:59:5a:5b")/IP(src="505:0505:0505:0505:0505:0505:0505:0506", dst="505:0505:0505:0505:0505:0505:0505:0507")/UDP(sport=5556, dport=5557)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_encap_l3_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_encap_l3_flow_entry(id, kat);
...
// decap_l3_IPv6 = Ether()/IP(src="6.6.6.8", dst="6.6.6.9")/UDP(dport=6635)/MPLS(label=54322, cos=3)/IP(src="606:0606:0606:0606:0606:0606:0606:0606", dst="606:0606:0606:0606:0606:0606:0606:0607")/UDP(sport=6666, dport=6667)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *
add_decap_l3_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_decap_l3_flow_entry(id, kat);
...
// encap_vxlan_IPv6 = Ether(src="20:21:22:23:24:25", dst="26:27:28:29:2a:2b")/IP(src="202:0202:0202:0202:0202:0202:0202:0206", dst="202:0202:0202:0202:0202:0202:0202:0207")/UDP(sport=2226, dport=2227)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *add_encap_vxlan_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_vxlan_encap_flow_entry(id, kat);
...
// decap_vxlan_IPv6 = Ether()/IP(src="4.4.4.8", dst="4.4.4.9")/UDP(dport=4789)/VXLAN(vni=333)/Ether(src="40:41:42:43:44:45", dst="46:47:48:49:4a:4b")/IP(src="404:0404:0404:0404:0404:0404:0404:0406", dst="404:0404:0404:0404:0404:0404:0404:0407")/UDP(sport=4446, dport=4447)
__rte_unused static struct n3k_mgmt_flow_tbl_handle *add_decap_vxlan_flow(struct rte_eth_dev *dev, int id, enum key_address_type kat)
{
	int ret;
	struct n3k_mgmt_flow_tbl_handle *handle;
	struct n3k_mgmt_flow_entry entry;

	entry = create_vxlan_decap_flow_entry(id, kat);
	...
	struct n3k_mgmt_flow_tbl_handle **handles, size_t flow_cnt)
{
	...
	if(prev_packet_cnt == NULL)
		rte_exit(EXIT_FAILURE, "%s(): calloc() failed", __func__);
...
__rte_unused static void test_flows(struct rte_eth_dev *dev)
{
	...
	handles[flow_cnt++] = add_local_flow(dev, 0, IPv4);
	handles[flow_cnt++] = add_local_flow(dev, 0, IPv6);
	handles[flow_cnt++] = add_encap_l3_flow(dev, 0, IPv4);
	handles[flow_cnt++] = add_encap_l3_flow(dev, 0, IPv6);
	handles[flow_cnt++] = add_decap_l3_flow(dev, 0, IPv4);
	handles[flow_cnt++] = add_decap_l3_flow(dev, 0, IPv6);
	handles[flow_cnt++] = add_decap_flow(dev, 0, IPv4);
	handles[flow_cnt++] = add_decap_flow(dev, 0, IPv6);
	handles[flow_cnt++] = add_encap_flow(dev, 0, IPv4);
	handles[flow_cnt++] = add_encap_flow(dev, 0, IPv6);
	handles[flow_cnt++] = add_drop_flow(dev, 0, IPv4);
	handles[flow_cnt++] = add_drop_flow(dev, 0, IPv6);
	handles[flow_cnt++] = add_local_mirror_flow(dev, 1, IPv4);
	handles[flow_cnt++] = add_local_mirror_flow(dev, 1, IPv6);
	handles[flow_cnt++] = add_decap_mirror_flow(dev, 1, IPv4);
	handles[flow_cnt++] = add_decap_mirror_flow(dev, 1, IPv6);
	handles[flow_cnt++] = add_local_nat_flow(dev, 2, IPv4);
	handles[flow_cnt++] = add_local_nat_flow(dev, 2, IPv6);
	handles[flow_cnt++] = add_encap_nat_flow(dev, 2, IPv4);
	handles[flow_cnt++] = add_encap_nat_flow(dev, 2, IPv6);
	handles[flow_cnt++] = add_decap_nat_flow(dev, 2, IPv4);
	handles[flow_cnt++] = add_decap_nat_flow(dev, 2, IPv6);
	handles[flow_cnt++] = add_encap_vxlan_flow(dev, 3, IPv4);
