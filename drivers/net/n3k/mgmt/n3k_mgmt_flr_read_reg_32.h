...
enum n3k_mgmt_flr_read_reg_32_blocks_order {
	...
	_N3K_MGMT_FLR_READ_REG_32_MAX,
};

/* Schedule register reading and wait for the result. Due to synchronization,
 * this function should be used only for debug purposes or in places not
 * critical to driver performance.
 */
int n3k_mgmt_flr_sync_read_reg_32(struct n3k_mgmt_hw *hw, uint32_t base,
	uint32_t reg, uint32_t *val);

int n3k_mgmt_flr_read_reg_32_handle_response(struct n3k_mgmt_hw *hw,
...
int n3k_mgmt_flr_schedule_read_reg_32(struct n3k_mgmt_hw *hw,
	struct n3k_mgmt_flr_command_read_reg_32 *reg_32_read);

#endif /* _N3K_MGMT_FLR_REG_32_READ_ */
