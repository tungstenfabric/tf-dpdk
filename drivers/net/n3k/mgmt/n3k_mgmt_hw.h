...
struct n3k_mgmt_hw {
	// TODO(n3k): verify what is needed here
	u64    req_features;
	u8     notify_region;
	u32    notify_off_multiplier;
	struct n3k_mgmt_pci_common_cfg *common_cfg;
	struct n3k_mgmt_net_config *dev_cfg;
	u8     *isr;
	u16    *notify_base;
	u16    *notify_addr[N3K_MGMT_MAX_QUEUES * 2];
	struct vring_info vring[N3K_MGMT_MAX_QUEUES * 2];
	u8 nr_vring;
	...
	struct n3k_mgmt_nios_shm_internal *nios_internal;
