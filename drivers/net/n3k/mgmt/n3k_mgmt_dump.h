...
/* Be sure that you provide at least 40 bytes:
 * (8*4 for address + 7 for collons + 1 for null termination)*/
const char *n3k_mgmt_convert_ipv6_to_str(char *buff, const uint8_t *addr);
